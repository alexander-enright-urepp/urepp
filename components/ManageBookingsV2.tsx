...
export default function ManageBookingsV2() {
  ...
  const fetchBookings = async () => {
    try {
      ...
      // Fetch pending appointments where I'm the recipient
      // (someone requested me and I need to respond)
      ...
      // Get requester details for each booking
      const bookingsWithDetails = await Promise.all(
        (data || []).map(async (appt: any) => {
          const { data: requester } = await supabase
            .from('profiles')
            .select('first_name, last_name, profile_picture_url')
            .eq('id', appt.requested_by)
            .single()
          ...
          return {
            ...
            display_name: requester 
              ...
              : appt.requested_by_name || 'Unknown User',
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900">
                  {(booking as any).display_name || booking.requested_by_name}
                </p>
