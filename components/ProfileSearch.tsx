...
import { SPORT_OPTIONS, getSportConfig, Sport } from '@/lib/sports'
...
export default function ProfileSearch() {
  ...
  // Update selected sport when filter changes
  useEffect(() => {
    if (filters.sport) {
  ...
  const searchProfiles = async () => {
    ...
    try {
      let supabaseQuery = supabase
        .from('profiles')
        .select('id, first_name, last_name, username, profile_picture_url, sport, grad_year, primary_position, city, state, stat_primary, stat_secondary, stat_tertiary')
